...
package com.example.homer.testhello;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), new Double(temp).toString()+"|"+new Double(barometer).toString(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private SensorEventListener mSensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (event.sensor.getType() == Sensor.TYPE_AMBIENT_TEMPERATURE) {
                ...
                updateTemperatureDisplay(new Double(fTemp).floatValue());
                temp = fTemp;
